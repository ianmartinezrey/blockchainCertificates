                    ...
                    <div className='row' >
                        ...
                        <div className="col col-md-7">
                            ...
                            <Form.Group className="mb-3" controlId="resolucion">
                                <Form.Label>Resolucion Institucion</Form.Label>
                                <Form.Control type="text" value={instituciones.get(certificado.institucion).resolucion} disabled />
                            </Form.Group>
    ...
    return (
        <>
            ...
            { showResults ? 
                <Results 
                cert={certificado} 
                link={"https://"+ certificado.ipfsHash + ".ipfs.w3s.link/"} 
                /> : null }
