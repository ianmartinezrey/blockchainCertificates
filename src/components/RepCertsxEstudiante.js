...
class RepCertsxEstudiante extends Component {
    ...
    render() {
        ...
        <div>
            ...
            <Container>
                <Card >
                    <Card.Header className=' subtitle4 page-header-blue'>Certificados por Estudiante</Card.Header>
                    <Card.Body className='div_gradient2'>
                        <Table className='dataTable' responsive stripped bordered hover size="sm">
                            ...
                            <tbody>
                                ...
                                return(
                                    <tr>
                                    <td>{this.state.instituciones.get(cert.institucion).institucion_name}</td>
                                    <td>{cert.nombre}</td>
                                    <td>{cert.titulo}</td>
...
export default RepCertsxEstudiante;
